...
def load_model(pariha):
	...
	# 테스트 데이터 로드 
	data <- read.csv(\"''' + pariha + '''\" , header = FALSE)
    ...
    time_stamp_file = open('./graph/' + result_name + '_RNN_time_LD.txt', 'w')
    time_stamp_file.write("mid = ")
